...
//Creamos una nueva cookie con la última fecha en este caso es la fecha en la que abandona su sesión
    ...
    setcookie($dni, date("d-m-Y H:i:s"), time() + 24 * 3600); //No le indicamos todo el directorio ya que solo se quiere tener accesos a esta cookie dentro de páginas restringidas
