                ...
                <ul class="nav__links">
                    ...
                    <li class="nav__item">
                        ...
                        if (isset($_SESSION['dni'])) {
                            echo '<span class="user">Bienvenido ' . htmlspecialchars($_SESSION['dni']) . '</span>';
                            echo '<a class= "close" href="?cerrar_sesion=1">Cerrar Sesión</a>';
                        } else {
                            echo '<span class="user">Invitado</span>';
                        }
                        ?>
                    </li>
                    <li class="nav__item">
